...
<h1>Increase Quantity by ? :</h1>
<br>
<form action="Increase_Quantity_confirm.php" method="POST" >
  <?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST")
    {
      ...
      echo "<label>&nbsp;&nbsp;&nbsp;&nbsp;<b>ADD :</b></label>";
      echo '<input type="number" min="1" step="1" value="1" placeholder="Enter Quantity to be Added:" name="quantity_add" required />';
