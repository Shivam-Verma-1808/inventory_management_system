...
<body>
<h1>Confirm Quantity Decrement:</h1>
<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $myItem_quantity_sub = mysqli_real_escape_string($conn,$_POST['quantity_sub']);
      ...
      $New_total_Quantity=$current_quantity-$myItem_quantity_sub;

      echo '<form action="Decrease_Quantity_final.php" method="post">';
